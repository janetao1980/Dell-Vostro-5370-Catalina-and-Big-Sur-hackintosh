...
将修改后的 CtlnaAHCIPort.kext 放入 oc 的 Kexts 文件夹，然后在 config 中添加声明，最后屏蔽原本的 AppleAHCIPort 即可。参考链接：https://dortania.github.io/OpenCore-Install-Guide/extras/big-sur/#supported-hardware
